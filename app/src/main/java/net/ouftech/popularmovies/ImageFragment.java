...
public class ImageFragment extends Fragment {
  ...
  public static ImageFragment newInstance(int position) {
    ...
    argument.putInt(KEY_IMAGE_RES, position);
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
    ...
    view.findViewById(R.id.image).setTransitionName("name"+position);
    ...
    public void onSaveInstanceState(@NonNull Bundle outState) {
        ...
        outState.putInt("hello", getArguments().getInt(KEY_IMAGE_RES));
    }
}
